...
export const closeBtn: React.CSSProperties = { background: 'none', border: 'none', fontSize: '24px', color: '#475569', cursor: 'pointer' };
...
export const formLabel: React.CSSProperties = { fontSize: '11px', fontWeight: '600', color: '#475569', marginBottom: '4px', display: 'block' };
export const formInput: React.CSSProperties = { width: '100%', padding: '10px', borderRadius: '8px', border: '1px solid #E5E5EA', marginBottom: '10px', boxSizing: 'border-box', fontSize: '16px' };
/** select 전용 - 드롭다운 가독성(18px) */
export const formSelect: React.CSSProperties = { ...formInput, fontSize: '18px', minHeight: '44px', padding: '10px 12px' };
export const inputDisabled: React.CSSProperties = { width: '100%', padding: '12px', background: '#F2F2F7', border: 'none', borderRadius: '10px', color: '#0f172a', WebkitTextFillColor: '#0f172a', opacity: 1, boxSizing: 'border-box' };
...
export const rejectBtn: React.CSSProperties = { flex: 1, background: '#E2E8F0', color: '#334155', border: 'none', padding: '12px', borderRadius: '8px', cursor: 'pointer', fontSize: '14px', fontWeight:'bold' };
...
export const statLabel: React.CSSProperties = { fontSize:'12px', color:'#475569', marginBottom:'5px' };
...
export const helperText: React.CSSProperties = { fontSize: '12px', color: '#1d4ed8', marginBottom: '10px', display: 'flex', alignItems: 'center', gap: '5px', background: '#F0F9FF', padding: '8px', borderRadius: '8px' };